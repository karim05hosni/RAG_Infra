...
# 2. Prepare the French text
french_text = "Bonjour, comment allez-vous aujourd'hui? J'espère que vous passez une excellente journée."

# 3. Tokenize the input text
# return_tensors="pt" ensures the output format is compatible with PyTorch
